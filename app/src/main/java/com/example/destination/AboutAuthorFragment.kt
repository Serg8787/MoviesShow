 ...
 * Use the [AboutAuthorFragment.newInstance] factory method to
...
class AboutAuthorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity?)!!.bottomNavView.visibility = View.INVISIBLE
    }
